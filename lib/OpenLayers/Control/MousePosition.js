...
OpenLayers.Control.MousePosition = OpenLayers.Class(OpenLayers.Control, {
    ...
    formatOutput: function(lonLat) {
        ...
        var londegrees = Math.floor(Math.abs(lonLat.lon));
        var latdegrees = Math.floor(Math.abs(lonLat.lat));
        var lonminutes = Math.abs((lonLat.lon%1)*60);
        var latminutes = Math.abs((lonLat.lat%1)*60);
        var newHtml =
            this.prefix +
            latdegrees.toPrecision(2) +
            "-" +
            latminutes.toFixed(1) + 
            this.separator +
            londegrees +
            "-" +
            lonminutes.toFixed(1) +
            this.suffix;
        return newHtml;
    },
